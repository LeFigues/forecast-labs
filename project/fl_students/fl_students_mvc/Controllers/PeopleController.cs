...
namespace fl_students_mvc.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,CI,Cellphone,Address,UserId")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,CI,Cellphone,Address,UserId")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
